...
function do_work() {
  ...
  if (gate == "GAND" || gate == "GOR") {
    ...
    x.innerHTML += `<tr class="d-flex style = "color: white !important;" >
                    <th class="col-4" style = "color: white !important">${gate.substring(1)}</th>
                    <th class="col-4" style = "color: white !important">${a}</th>
                    <th class="col-5" style = "color: white !important">${b}</th>
                    <th class="col-5" style = "color: white !important">${z}</th>
                    <th class="col-5 ${(sz == z) ? "bg-success" : "bg-danger"}" style = "color: white !important">${sz}</th>
                </tr> `
  }
  else {
    a = 0
